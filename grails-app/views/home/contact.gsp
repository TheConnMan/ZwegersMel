				...
				<tr>
					...
					<td>
						...
						<g:form action="submitContact" class="contact">
							...
							<g:field type="text" name="name" required="true" maxlength="255" value="${ flash.params?.name }" />
							<label>Email</label><span class="required">*</span>
							<g:field type="email" name="email" required="true" maxlength="255" value="${ flash.params?.email }" />
							<label>Comment</label><span class="required">*</span>
							<g:textArea name="comment" required="true" maxlength="500" value="${ flash.params?.comment }" />
